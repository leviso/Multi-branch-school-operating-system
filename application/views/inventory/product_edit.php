...
if (empty($product)) {
    echo '<div class="alert alert-danger">Product data not found. <a href="'.base_url('inventory/product').'">Go back to product list</a></div>';
    return;
}
?>
<section class="panel">
				...
				<?php endif; ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<span class="help-block"><?=translate('alert_when_stock_below')?></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							<div class="checkbox-custom checkbox-default">
								<input type="checkbox" name="is_returnable" id="is_returnable" value="1" <?php echo (isset($product['is_returnable']) && $product['is_returnable'] == 1) ? 'checked' : ''; ?>>
