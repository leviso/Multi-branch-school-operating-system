					...
					<table class="table table-bordered table-condensed table-hover mb-none tbr-top table-export">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<!-- Collect Payment - Only users with collect_fees permission (Accountant) -->
									<?php if (get_permission('collect_fees', 'is_add')): ?>
										<a href="<?php echo base_url('fees/invoice/' . $row['student_id']);?>" class="btn btn-default btn-circle" data-toggle="tooltip" title="<?=translate('collect_fees')?>">
											<i class="far fa-arrow-alt-circle-right"></i>
										</a>
									<?php endif; ?>

									<!-- View Invoice - Anyone with view permission -->
									<?php if (get_permission('invoice', 'is_view')): ?>
										<a href="<?php echo base_url('fees/invoice/' . $row['student_id']);?>" class="btn btn-info btn-circle" data-toggle="tooltip" title="<?=translate('view_invoice')?>">
									...
									<?php if (is_superadmin_loggedin()): ?>
										<a class="btn btn-danger icon btn-circle" onclick="confirm_modal('<?=base_url('fees/invoice_delete/' . $row['student_id'])?>')" data-toggle="tooltip" title="<?=translate('delete')?>">
