...
$(document).ready(function () {
    ...
    $('#sendWishes').on('click', function() {
        ...
        checkCreditsAndSend('student', arrayID, branchID, count, btn);
    });
    
    // Function to check credits and send
    function checkCreditsAndSend(type, arrayID, branchID, count, btn) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                confirmText += "<p><strong>Send birthday wishes to " + count + " " + type + "(s)?</strong></p>";
