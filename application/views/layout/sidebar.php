            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'inventory' || $main_menu == 'inventory_report') echo 'nav-expanded nav-active'; ?>">
                        ...
                        <!-- STOCK ALERTS MENU ITEM -->
                        <?php if(get_permission('inventory_report', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'inventory/stock_alerts') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('inventory/stock_alerts'); ?>">
                                    <span><i class="fas fa-exclamation-triangle" aria-hidden="true"></i><?php echo translate('stock_alerts'); ?></span>
                                    <?php 
                                    $branch_id = $this->application_model->get_branch_id();
                                    $alert_count = $this->db->select('COUNT(*) as count')
                                        ->from('product')
                                        ...
                                        ->count;
                                    if ($alert_count > 0): ?>
                                    <span class="badge badge-danger"><?php echo $alert_count; ?></span>
                                    <?php endif; ?>
                                </a>
                            </li>
                        <?php } ?>
                        ...
                        <?php } if(get_permission('product_sale', 'is_view')){ ?>
                        ...
                        <?php } if(get_permission('product_issue', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'inventory/issue') echo 'nav-active'; ?>">
                              ...
                              <!-- ============================================ -->
                            <!-- NEW INVENTORY REPORTS - ADD THESE LINKS -->
                            <!-- ============================================ -->
                            
                            <!-- Uniform Stock Balance Report -->
                            <li class="<?php if ($sub_page == 'inventory/uniform_stock_report') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('inventory/uniform_stock_report'); ?>">
                                    <span><i class="fas fa-tshirt"></i> <?php echo translate('uniform_stock_balance'); ?></span>
                                </a>
                            </li>
                            
                            <!-- Weekly Consumption Report -->
                            <li class="<?php if ($sub_page == 'inventory/weekly_consumption_report') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('inventory/weekly_consumption_report'); ?>">
                                    <span><i class="fas fa-chart-line"></i> <?php echo translate('weekly_consumption'); ?></span>
                                </a>
                            </li>
                            ...
                            <li class="<?php if ($sub_page == 'inventory/manage_report_groups') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('inventory/manage_report_groups'); ?>">
                                    <span><i class="fas fa-layer-group"></i> <?=translate('manage_report_groups')?></span>
                                </a>
                            </li>

                            <li class="<?php if ($sub_page == 'inventory/assign_product_group') echo 'nav-active'; ?>">
                                <a href="<?php echo base_url('inventory/assign_product_to_group'); ?>">
                                    <span><i class="fas fa-tags"></i> <?=translate('assign_products_to_groups')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <!-- ============================================ -->
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'admission') echo 'nav-expanded nav-active';?>">
                        ...
                        <?php } if(get_permission('online_admission', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'online_admission/index' || $sub_page =='online_admission/approved') echo 'nav-active';?>">
                             ...
                             <?php } if(get_permission('online_admission', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'online_admission/index' || $sub_page =='online_admission/interviews') echo 'nav-active';?>">
                                <a href="<?=base_url('online_admission/interviews')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('Admission Interviews')?></span>
                                </a>
                            </li>
...
<!-- ============================================ -->
<?php 
// Check if user has STARS permission
...
<li class="nav-parent <?php if ($main_menu == 'stars') echo 'nav-expanded nav-active';?>">
    <a>
        ...
        <span><?=translate('stars')?> (STARS)</span>
    </a>
    <ul class="nav nav-children">
        <!-- Dashboard -->
        <?php if (get_permission('stars', 'is_view')): ?>
        <li class="<?php if ($sub_page == 'stars/stars_dashboard') echo 'nav-active';?>">
            <a href="<?=base_url('stars/stars_dashboard')?>">
                <span><i class="fas fa-chart-line"></i> <?=translate('dashboard')?></span>
            </a>
        </li>
        <?php endif; ?>
        ...
        <?php if (get_permission('stars', 'is_view')): ?>
        <li class="<?php if ($sub_page == 'stars/assessments') echo 'nav-active';?>">
            <a href="<?=base_url('stars/assessments')?>">
                <span><i class="fas fa-clipboard-list"></i> <?=translate('transfer_assessments')?></span>
                <?php if (isset($stars_badges['pending_assessments']) && $stars_badges['pending_assessments'] > 0): ?>
                <span class="badge badge-warning pull-right"><?=$stars_badges['pending_assessments']?></span>
                <?php endif; ?>
            </a>
        </li>
        <?php endif; ?>
        ...
        <!-- Active IARPs -->
        <?php if (get_permission('stars', 'is_view')): ?>
        <li class="<?php if ($sub_page == 'stars/active_iarp') echo 'nav-active';?>">
            <a href="<?=base_url('stars/active_iarp')?>">
                <span><i class="fas fa-file-medical"></i> <?=translate('active_recovery_plans')?></span>
                <?php if (isset($stars_badges['active_iARPs']) && $stars_badges['active_iARPs'] > 0): ?>
                <span class="badge badge-success pull-right"><?=$stars_badges['active_iARPs']?></span>
                <?php endif; ?>
            </a>
        </li>
        <?php endif; ?>
        ...
        <li class="<?php if ($sub_page == 'stars/manage_topics') echo 'nav-active';?>">
            <a href="<?=base_url('stars/manage_topics')?>">
                <span><i class="fas fa-book"></i> <?=translate('curriculum_topics')?></span>
            </a>
        </li>

        <!-- Manage Subtopics -->
        <li class="<?php if ($sub_page == 'stars/manage_subtopics') echo 'nav-active';?>">
            <a href="<?=base_url('stars/manage_subtopics')?>">
                <span><i class="fas fa-layer-group"></i> <?=translate('manage_subtopics')?></span>
            </a>
        </li>
        
        <!-- Recovery Reports -->
        <?php if (get_permission('stars', 'is_view')): ?>
        <li class="<?php if ($sub_page == 'stars/reports') echo 'nav-active';?>">
            <a href="<?=base_url('stars/reports')?>">
                <span><i class="fas fa-chart-pie"></i> <?=translate('recovery_reports')?></span>
            </a>
        </li>
        <?php endif; ?>
    </ul>
...
<?php endif; ?>
                    ...
                    <!-- TEACHER INTELLIGENCE SYSTEM - New Menu -->
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'payroll' || $main_menu == 'advance_salary' || $main_menu == 'leave' || $main_menu == 'award') echo 'nav-expanded nav-active';?>">
                        ...
                        <ul class="nav nav-children">
                            ...
                            <?php } ?>
                    <!-- ============================================ -->
                    <!-- TEACHER INTELLIGENCE SYSTEM                 -->
                    <!-- ============================================ -->
                    <?php if (get_permission('tis_dashboard', 'is_view') ||
                              get_permission('tis_workload', 'is_view') ||
                              get_permission('tis_performance', 'is_view') ||
                              get_permission('tis_risks', 'is_view')): ?>
                    <li class="nav-parent <?php if ($main_menu == 'tis') echo 'nav-expanded nav-active';?>">
                        <a>
                            <i class="fas fa-brain" style="color: #6c5ce7;"></i><span><?=translate('teacher_intelligence')?></span>
                        </a>
                        <ul class="nav nav-children">
                            <?php if(get_permission('tis_dashboard', 'is_view')): ?>
                            <li class="<?php if ($sub_page == 'tis/dashboard') echo 'nav-active';?>">
                                <a href="<?=base_url('dashboard/tis')?>">
                                    <span><i class="fas fa-chart-line"></i> <?=translate('tis_dashboard')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            
                            <?php if(get_permission('tis_workload', 'is_view')): ?>
                            <li class="<?php if ($sub_page == 'tis/workload') echo 'nav-active';?>">
                                <a href="<?=base_url('employee/workload')?>">
                                    <span><i class="fas fa-tachometer-alt"></i> <?=translate('workload_management')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            
                            <?php if(get_permission('tis_performance', 'is_view')): ?>
                            <li class="<?php if ($sub_page == 'tis/performance') echo 'nav-active';?>">
                                <a href="<?=base_url('employee/performance')?>">
                                    <span><i class="fas fa-star-of-life"></i> <?=translate('performance_scores')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            
                            <?php if(get_permission('tis_risks', 'is_view')): ?>
                            <li class="<?php if ($sub_page == 'tis/risks') echo 'nav-active';?>">
                                <a href="<?=base_url('employee/risks')?>">
                                    <span><i class="fas fa-exclamation-triangle"></i> <?=translate('risk_analysis')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                        </ul>
                            ...
                            if ($main_menu == 'classes' || $main_menu == 'sections' || $main_menu == 'class_teacher_allocation') echo 'nav-expanded nav-active'; ?>">
                                ...
                                <ul class="nav nav-children">
                                  ...
                                  <?php if (get_permission('subject_class_assign', 'is_view')): ?>
                                    <li class="<?php if ($sub_page == 'subject/enrollment') echo 'nav-active';?>">
                                        <a href="<?=base_url('subject/enrollment')?>">
                                            <span><i class="fas fa-caret-right"></i> <i class="fas fa-user-graduate"></i> <?=translate('student_subject_enrollment')?></span>
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                    <?php } ?>
                   ...
                   <?php
                    if (moduleIsEnabled('homework')) {
                        // Check if user has ANY homework permission
                        $has_homework_perm = get_permission('homework', 'is_view') ||
                                            get_permission('homework', 'is_add') ||
                                            get_permission('homework', 'is_edit') ||
                                            get_permission('homework', 'is_delete') ||
                                            get_permission('homework_evaluate', 'is_view') ||
                                            get_permission('homework_evaluate', 'is_add') ||
                                            get_permission('evaluation_report', 'is_view');
                        
                        if ($has_homework_perm) {
                    ?>
                    <!-- Homework Module - Enhanced with Submissions & Feedback -->
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'homework') echo 'nav-expanded nav-active';?>">
                        <a>
                            ...
                            <?php 
                            // Optimized badge - direct query without model call
                            $user_role = $this->session->userdata('loggedin_role_id');
                            if ($user_role == 3): // Teacher role only
                                ...
                                if (!empty($subjects)):
                                    ...
                                    // Count pending submissions (no feedback)
                                    $pending = $this->db->select('COUNT(DISTINCT hs.id) as count')
                                                    ->from('homework_submit hs')
                                                    ->join('homework h', 'h.id = hs.homework_id')
                                                    ->where_in('h.subject_id', $subject_ids)
                                                    ->where('h.branch_id', $branch_id)
                                                    ->where('(hs.feedback IS NULL OR hs.feedback = "")')
                                                    ->get()
                                                    ->row()
                                                    ->count ?? 0;
                                    if ($pending > 0): ?>
                                    <span class="badge badge-danger pull-right"><?php echo $pending; ?></span>
                                    <?php endif;
                                endif;
                            endif; ?>
                        </a>
                        <ul class="nav nav-children">
                            ...
                            <li class="<?php if ($sub_page == 'homework/index' || $sub_page == 'homework/add' || $sub_page == 'homework/edit') echo 'nav-active';?>">
                                <a href="<?=base_url('homework')?>">
                                    <span><i class="fas fa-caret-right"></i> <?=translate('homework_list')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            
                            <?php if(get_permission('homework', 'is_add')): ?>
                            <li class="<?php if ($sub_page == 'homework/add') echo 'nav-active';?>">
                                <a href="<?=base_url('homework/add')?>">
                                    <span><i class="fas fa-caret-right"></i> <i class="fas fa-plus-circle"></i> <?=translate('add_homework')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            
                            <?php if(get_permission('homework_evaluate', 'is_view')): ?>
                            <li class="<?php if ($sub_page == 'homework/manage_submissions') echo 'nav-active';?>">
                                <a href="<?=base_url('homework/manage_submissions')?>">
                                    <span><i class="fas fa-caret-right"></i> <i class="fas fa-check-double"></i> <?=translate('manage_submissions')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="<?php if ($sub_page == 'homework/report') echo 'nav-active';?>">
                                <a href="<?=base_url('homework/report')?>">
                                    <span><i class="fas fa-caret-right"></i> <i class="fas fa-chart-bar"></i> <?=translate('evaluation_report')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(is_admin_loggedin() || is_superadmin_loggedin() || get_permission('homework_analytics', 'is_view')): ?>
                            <li class="<?php if ($sub_page == 'homework/analytics') echo 'nav-active';?>">
                                <a href="<?=base_url('homework/analytics')?>">
                                    <span><i class="fas fa-caret-right"></i> <i class="fas fa-chart-line"></i> <?=translate('homework_analytics')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(get_permission('evaluation_report', 'is_view')): ?>
                            <li class="<?php if ($sub_page == 'homework/completion_report') echo 'nav-active';?>">
                                <a href="<?=base_url('homework/completion_report')?>">
                                    <span><i class="fas fa-caret-right"></i> <i class="fas fa-chart-bar"></i> <?=translate('homework_completion_report')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                            <?php if(get_permission('homework', 'is_view')): ?>
                            <li class="<?php if ($sub_page == 'homework/comments') echo 'nav-active';?>">
                                <a href="<?=base_url('homework/comments')?>">
                                    <span><i class="fas fa-caret-right"></i> <i class="fas fa-comments"></i> <?=translate('homework_discussion')?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'hostels' || $main_menu == 'transport') echo 'nav-expanded nav-active';?>">
                        ...
                        <ul class="nav nav-children">
                            ...
                            if (moduleIsEnabled('hostel')) {
                                ...
                                get_permission('hostel_room', 'is_view') ||
                                get_permission('hostel_allocation', 'is_view') ||
                                $this->session->userdata('loggedin_role_id') == 3) { // Allow teachers to see hostel menu
                            ?>
                            <!-- hostels -->
<li class="nav-parent <?php if ($main_menu == 'hostels') echo 'nav-expanded nav-active';?>">
    ...
    <ul class="nav nav-children">
        ...
        <!-- Dashboard - Visible to all with view permission -->
        <?php if(get_permission('hostel', 'is_view') || $this->session->userdata('loggedin_role_id') == 3): ?>
        <li class="<?php if ($sub_page == 'hostels/dashboard') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/dashboard')?>">
                <i class="fas fa-tachometer-alt"></i> <span><?=translate('dashboard')?></span>
            </a>
        </li>
        <?php endif; ?>
        
        <!-- My Assigned Rooms - ONLY for teachers (role_id = 3) -->
        <?php if($this->session->userdata('loggedin_role_id') == 3): ?>
        <li class="<?php if ($sub_page == 'hostels/my_assigned_rooms') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/my_assigned_rooms')?>">
                <i class="fas fa-door-open"></i> <span><?=translate('my_assigned_rooms')?></span>
            </a>
        </li>
        <?php endif; ?>
        
                <!-- ============================================ -->
        <!-- EMERGENCY MANAGEMENT SECTION - UPDATED FOR ALL ROLES -->
        <!-- ============================================ -->
        <?php 
        // Show emergency menu for users with permission OR teachers (role=3) can view incidents
        $user_role = $this->session->userdata('loggedin_role_id');
        if(get_permission('hostel_emergency', 'is_view') || $user_role == 3 || $user_role == 6 || $user_role == 7): 
        ?>
        <li class="nav-parent <?php if ($main_menu == 'hostel_emergency') echo 'nav-expanded nav-active';?>">
            <a>
                <i class="fas fa-exclamation-triangle" style="color: #ff6b6b;"></i> 
                <span style="color: #ff6b6b;"><?=translate('emergency_management')?></span>
            </a>
            <ul class="nav nav-children">
                <!-- Emergency Incidents - All roles can view -->
                <li class="<?php if ($sub_page == 'hostel_emergency/incidents') echo 'nav-active';?>">
                    <a href="<?=base_url('hostel_emergency/incidents')?>">
                        <span><i class="fas fa-bell"></i> <?=translate('emergency_incidents')?></span>
                        <?php 
                        // Show badge only for admin/teacher/superadmin (not for parent/student)
                        if($user_role != 6 && $user_role != 7):
                        $branchID = $this->application_model->get_branch_id();
                        $pending_count = $this->db->select('COUNT(*) as count')
                ...
                <!-- Report New Incident - Admin (role 2) and Teacher (role 3) can add -->
                <?php 
                $user_role = $this->session->userdata('loggedin_role_id');
                if(get_permission('hostel_emergency', 'can_add') || $user_role == 2 || $user_role == 3): 
                ?>
                <li class="<?php if ($sub_page == 'hostel_emergency/report') echo 'nav-active';?>">
                    <a href="<?=base_url('hostel_emergency/report')?>">
                        <span><i class="fas fa-plus-circle"></i> <?=translate('report_incident')?></span>
                    </a>
                </li>
                <?php endif; ?>
                
                <!-- Emergency Types - Only Admin and Superadmin -->
                <?php if(get_permission('emergency_types', 'is_view') && $user_role != 3 && $user_role != 6 && $user_role != 7): ?>
                <li class="<?php if ($sub_page == 'hostel_emergency/types') echo 'nav-active';?>">
                    <a href="<?=base_url('hostel_emergency/types')?>">
                        <span><i class="fas fa-tag"></i> <?=translate('emergency_types')?></span>
                    </a>
                </li>
                <?php endif; ?>
                
                <!-- Emergency Contacts - Only Admin and Superadmin -->
                <?php if(get_permission('emergency_contacts', 'is_view') && $user_role != 3 && $user_role != 6 && $user_role != 7): ?>
                <li class="<?php if ($sub_page == 'hostel_emergency/contacts') echo 'nav-active';?>">
                    <a href="<?=base_url('hostel_emergency/contacts')?>">
                        <span><i class="fas fa-phone-alt"></i> <?=translate('emergency_contacts')?></span>
                    </a>
                </li>
                <?php endif; ?>
                
                <!-- Student Medical Info - Admin, Superadmin, Teacher -->
                <?php if(get_permission('student_medical', 'is_view') && $user_role != 6 && $user_role != 7): ?>
                <li class="<?php if ($sub_page == 'hostel_emergency/student_medical') echo 'nav-active';?>">
                    <a href="<?=base_url('hostel_emergency/student_medical')?>">
                        <span><i class="fas fa-notes-medical"></i> <?=translate('student_medical')?></span>
                    </a>
                </li>
                <?php endif; ?>
                
                <!-- Medical Report - Admin, Superadmin, Teacher -->
                <?php if(get_permission('student_medical', 'is_view') && $user_role != 6 && $user_role != 7): ?>
                <li class="<?php if ($sub_page == 'hostel_emergency/medical_report') echo 'nav-active';?>">
                    <a href="<?=base_url('hostel_emergency/medical_report')?>">
                        <span><i class="fas fa-chart-bar"></i> <?=translate('medical_report')?></span>
                    </a>
                </li>
                <?php endif; ?>
            </ul>
        ...
        <?php endif; ?>
        <!-- ============================================ -->
        <!-- END EMERGENCY MANAGEMENT SECTION -->
        <!-- ============================================ -->
        <!-- Hostel Master - Admin/Superadmin only -->
        ...
        <li class="<?php if ($sub_page == 'hostels/index' || $sub_page == 'hostels/edit') echo 'nav-active';?>">
            <a href="<?=base_url('hostels')?>">
                <i class="fas fa-door-open"></i><?=translate('hostel_master')?>
            </a>
        </li>
        <?php endif; ?>
        ...
        <li class="<?php if ($sub_page == 'hostels/room' || $sub_page == 'hostels/room_edit') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/room')?>">
                <i class="fas fa-bed"></i><?=translate('hostel_room')?>
            </a>
        </li>
        <li class="<?php if ($sub_page == 'hostels/room_occupancy') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/room_occupancy')?>">
                <i class="fas fa-bed"></i> <span><?=translate('room_occupancy')?></span>
            </a>
        </li>
        <?php endif; ?>
        ...
        <li class="<?php if ($sub_page == 'hostels/category') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/category')?>">
                <i class="fas fa-hotel"></i> <span><?=translate('category')?></span>
            </a>
        </li>
        <?php endif; ?>
        ...
        <li class="<?php if ($sub_page == 'hostels/allocation') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/allocation_report')?>">
               <i class="fas fa-clipboard-list"></i><?=translate('allocation_report')?>
            </a>
        </li>
        <?php endif; ?>
        ...
        <!-- Room Inspections -->
        <?php if(get_permission('hostel', 'is_view') || $this->session->userdata('loggedin_role_id') == 3): ?>
        <li class="<?php if ($sub_page == 'hostels/inspections') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/inspections')?>">
                <i class="fas fa-clipboard-list"></i> <span><?=translate('room_inspections')?></span>
            </a>
        </li>
        <?php endif; ?>
        
        <!-- Inspection Templates - Admin Only -->
        <?php if (get_permission('hostel', 'is_edit')): ?>
        <li class="<?php if ($sub_page == 'hostels/inspection_templates') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/inspection_templates')?>">
                <i class="fas fa-clipboard-list"></i> <span><?=translate('inspection_templates')?></span>
            </a>
        </li>
        <?php endif; ?>
        ...
        <?php if (get_permission('hostel', 'is_edit')): ?>
        <li class="<?php if ($sub_page == 'hostels/staff_assignments') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/staff_assignments')?>">
                <i class="fas fa-user-tag"></i> <span><?=translate('staff_assignments')?></span>
            </a>
        </li>
        <?php endif; ?>
        
        <!-- Inventory Items -->
        <?php if(get_permission('hostel_inventory', 'is_view')): ?>
        <li class="<?php if ($sub_page == 'hostels/inventory_items') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/inventory_items')?>">
                <i class="fas fa-boxes"></i> <span><?=translate('inventory_items')?></span>
            </a>
        </li>
        <?php endif; ?>
        ...
        <!-- Inventory Reports -->
        <?php if(get_permission('hostel_inventory', 'is_view')): ?>
        <li class="<?php if ($sub_page == 'hostels/inventory_reports') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/inventory_reports')?>">
                <i class="fas fa-chart-bar"></i> <span><?=translate('inventory_reports')?></span>
            </a>
        </li>
        <li class="<?php if ($sub_page == 'hostels/reports') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/reports')?>">
                <i class="fas fa-chart-bar"></i> <span><?=translate('hostel_reports')?></span>
            </a>
        </li>
        <?php endif; ?>
        
        <!-- Repairs & Maintenance -->
        <?php if(get_permission('hostel_repairs', 'is_view')): ?>
        <li class="<?php if ($sub_page == 'hostels/repairs') echo 'nav-active';?>">
            <a href="<?=base_url('hostels/repairs')?>">
                <i class="fas fa-wrench"></i> <span><?=translate('repairs_maintenance')?></span>
            </a>
        </li>
        <?php endif; ?>
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'library') echo 'nav-expanded nav-active';?>">
                        ...
                        <ul class="nav nav-children">
                            ...
                            <?php if (get_permission('book_manage', 'is_view')): ?>
                                <li class="<?php if ($sub_page == 'library/reports') echo 'nav-active';?>">
                                    <a href="<?=base_url('library/reports')?>">
                                        <span><i class="fas fa-caret-right"></i> <i class="fas fa-chart-bar"></i> <?=translate('library_reports')?></span>
                                    </a>
                                </li>
                                <?php if (get_permission('book_manage', 'is_view')): ?>
                                <li class="<?php if ($sub_page == 'library/student_borrowing_history') echo 'nav-active';?>">
                                    <a href="<?=base_url('library/student_borrowing_history')?>">
                                        <span><i class="fas fa-caret-right"></i> <i class="fas fa-user-graduate"></i> <?=translate('student_borrowing_history')?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php if (get_permission('book_manage', 'is_view')): ?>
                                <li class="<?php if ($sub_page == 'library/advanced_reports') echo 'nav-active';?>">
                                    <a href="<?=base_url('library/advanced_reports')?>">
                                        <span><i class="fas fa-caret-right"></i> <i class="fas fa-chart-pie"></i> <?=translate('advanced_library_reports')?></span>
                                    </a>
                                </li>
                                <?php endif; ?>

                                <?php if (is_admin_loggedin() || is_superadmin_loggedin()): ?>
                                <li class="<?php if ($sub_page == 'library/settings') echo 'nav-active';?>">
                                    <a href="<?=base_url('library/settings')?>">
                                        <span><i class="fas fa-caret-right"></i> <i class="fas fa-cog"></i> <?=translate('library_settings')?></span>
                                    </a>
                                </li>
                                <?php endif; ?>
                            <?php } ?>
                    ...
                    if (moduleIsEnabled('bulk_sms_and_email')) {
                        ...
                        get_permission('purchasesms', 'is_add')||
                        get_permission('purchasesms', 'is_view') ||
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'sendsmsmail') echo 'nav-expanded nav-active';?>">
                        ...
                        <ul class="nav nav-children">
                            ...
                            <li class="<?php if ($sub_page == 'sendsmsmail/sms' || $sub_page == 'sendsmsmail/email') echo 'nav-active';?>">
                                ...
                                <!-- scheduled sms -->
                            <li class="<?php if ($sub_page == 'sendsmsmail/scheduled') echo 'nav-active';?>">
                                <a href="<?=base_url('sendsmsmail/scheduled')?>">
                                    <span><i class="fas fa-caret-right"></i><?=translate('scheduled_messages')?></span>
                                </a>
                            </li>
                            <!-- Add this AFTER the Scheduled Messages link -->
                            <li class="<?php if ($sub_page == 'sendsmsmail/sent_messages') echo 'nav-active';?>">
                                <a href="<?=base_url('sendsmsmail/sent_messages')?>">
                                    <span><i class="fas fa-caret-right"></i><?=translate('sent_messages')?></span>
                                </a>
                            </li>
                            ...
                            <li class="<?php if ($sub_page == 'birthday/staff') echo 'nav-active';?>">
                             ...
                             <?php } if (get_permission('sendsmsmail', 'is_add') || get_permission('purchasesms', 'is_view')) {  ?>
                            <li class="<?php if ($sub_page == 'sendsmsmail/purchase') echo 'nav-active';?>">
                                <a href="<?=base_url('sendsmsmail/purchase')?>">
                                    <span><i class="fas fa-caret-right"></i> Purchase SMS</span>
                                </a>
                            </li>
                             <?php } if (is_superadmin_loggedin()) {  ?>
                            <li class="<?php if ($sub_page == 'sendsmsmail/manual_verify') echo 'nav-active';?>">
                                <a href="<?php echo base_url('sendsmsmail/manual_verify'); ?>">
                                    <i class="fas fa-caret-right"></i> <span>Manual Verification</span>
                                </a>
                            </li>
                            <?php } if (is_superadmin_loggedin() || get_permission('sendsmsmail_report', 'is_view')) {  ?>
                            <li class="<?php if ($sub_page == 'sendsmsmail/credit_purchase_report') echo 'nav-active';?>">
                                <a href="<?php echo base_url('sendsmsmail/credit_purchase_report'); ?>">
                                    <i class="fas fa-caret-right"></i> <span>Credit Purchase Report</span>
                                </a>
                            </li>
                            <?php } ?>
                        </ul>
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'accounting_repots' ||
                        ...
                        <li class="sub-menu">
                            <a href="javascript:void(0);">
                                <i class="fa fa-cubes"></i> <span>Subscription</span>
                            </a>
                            
                                <li><a href="<?=base_url('subscription_admin/plans')?>"><i class="fa fa-circle-o"></i> Plans</a></li>
                                <li><a href="<?=base_url('subscription_admin/branch_subscriptions')?>"><i class="fa fa-circle-o"></i> Assign to Branch</a></li>
                                <li><a href="<?=base_url('subscription_admin/revenue')?>"><i class="fa fa-circle-o"></i> Revenue Report</a></li>
                        ...
                        <?php if (is_superadmin_loggedin()): ?>
                        <li class="nav-item">
                            <a href="<?=base_url('admin/reconcile')?>" class="nav-link">
                                <i class="fas fa-check-double"></i>
                                <span><?=translate('payment_reconciliation')?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                         <!-- Subscription Reconciliation -->
                        ...
                        <li class="<?=($this->uri->segment(2) == 'purchase') ? 'active' : ''?>">
                            <a href="<?=base_url('subscription/purchase')?>">
                                <i class="fa fa-shopping-cart"></i> <span>Purchase Subscription</span>
                            </a>
                        </li>
                        <?php endif; ?>
                        ...
                        <?php if(get_permission('inventory_report', 'is_view')){  ?>
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'inventory_report') echo 'nav-expanded'; ?>">
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <li class="<?php if ($sub_page == 'inventory/stock_alerts') echo 'nav-active'; ?>">
                                        <a href="<?php echo base_url('inventory/stock_alerts'); ?>">
                                            <i class="fas fa-exclamation-triangle" aria-hidden="true"></i> <?php echo translate('stock_alerts'); ?>
                                        </a>
                                    </li>
                                    <li class="<?php if ($sub_page == 'inventory/product_report') echo 'nav-active'; ?>">
                                        <a href="<?php echo base_url('inventory/product_report'); ?>">
                                            <i class="fas fa-chart-line"></i> <?php echo translate('product_report'); ?>
                                        </a>
                                    </li>
                                    
                                    <!-- NEW: Uniform Stock Balance Report -->
                                    <li class="<?php if ($sub_page == 'inventory/uniform_stock_report') echo 'nav-active'; ?>">
                                        <a href="<?php echo base_url('inventory/uniform_stock_report'); ?>">
                                            <i class="fas fa-tshirt"></i> <?php echo translate('uniform_stock_balance'); ?>
                                        </a>
                                    </li>
                                    
                                    <!-- NEW: Weekly Consumption Report -->
                                    <li class="<?php if ($sub_page == 'inventory/weekly_consumption_report') echo 'nav-active'; ?>">
                                        <a href="<?php echo base_url('inventory/weekly_consumption_report'); ?>">
                                            <i class="fas fa-chart-line"></i> <?php echo translate('weekly_consumption'); ?>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                    ...
                    $tis_module = $this->db->where('modules_id', 26)->where('branch_id', $this->application_model->get_branch_id())->get('modules_manage')->row();
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'tis') echo 'nav-expanded nav-active';?>">
                        ...
                        <ul class="nav nav-children">
                            <!-- Dashboard -->
                            <li class="<?php if ($sub_page == 'tis/dashboard') echo 'nav-active';?>">
                                <a href="<?=base_url('tis/dashboard')?>">
                                    <span><i class="fas fa-chart-line"></i> <?=translate('tis_dashboard')?></span>
                                </a>
                            </li>
                            
                            <!-- Workload Management -->
                            <li class="nav-parent <?php if ($main_menu == 'tis_workload') echo 'nav-expanded nav-active';?>">
                                <a><span><i class="fas fa-tachometer-alt"></i> <?=translate('workload_management')?></span></a>
                                <ul class="nav nav-children">
                                    <li class="<?php if ($sub_page == 'tis/workload') echo 'nav-active';?>">
                                        <a href="<?=base_url('tis/workload')?>">
                                            <span><i class="fas fa-eye"></i> <?=translate('workload_overview')?></span>
                                        </a>
                                    </li>
                                    <?php if(is_admin_loggedin() || is_superadmin_loggedin()): ?>
                                    <li class="<?php if ($sub_page == 'tis/workload/balance') echo 'nav-active';?>">
                                        <a href="<?=base_url('tis/workload/balance')?>">
                                            <span><i class="fas fa-balance-scale"></i> <?=translate('balance_workload')?></span>
                                        </a>
                                    </li>
                                    <li class="<?php if ($sub_page == 'tis/workload/config') echo 'nav-active';?>">
                                        <a href="<?=base_url('tis/workload/config')?>">
                                            <span><i class="fas fa-cog"></i> <?=translate('workload_settings')?></span>
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                </ul>
                            ...
                            <!-- Performance -->
                            <li class="nav-parent <?php if ($main_menu == 'tis_performance') echo 'nav-expanded nav-active';?>">
                                <a><span><i class="fas fa-star-of-life"></i> <?=translate('performance')?></span></a>
                                <ul class="nav nav-children">
                                    <li class="<?php if ($sub_page == 'tis/performance') echo 'nav-active';?>">
                                        <a href="<?=base_url('tis/performance')?>">
                                            <span><i class="fas fa-chart-bar"></i> <?=translate('performance_scores')?></span>
                                        </a>
                                    </li>
                                    <?php if(is_admin_loggedin() || is_superadmin_loggedin()): ?>
                                    <li class="<?php if ($sub_page == 'tis/performance/rankings') echo 'nav-active';?>">
                                        <a href="<?=base_url('tis/performance/rankings')?>">
                                            <span><i class="fas fa-trophy"></i> <?=translate('teacher_rankings')?></span>
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                </ul>
                            ...
                            <!-- Duties -->
                            <li class="nav-parent <?php if ($main_menu == 'tis_duties') echo 'nav-expanded nav-active';?>">
                                <a><span><i class="fas fa-clipboard-list"></i> <?=translate('duties')?></span></a>
                                <ul class="nav nav-children">
                                    <li class="<?php if ($sub_page == 'tis/duties') echo 'nav-active';?>">
                                        <a href="<?=base_url('tis/duties')?>">
                                            <span><i class="fas fa-user-clock"></i> <?=translate('my_duties')?></span>
                                        </a>
                                    </li>
                                    <?php if(is_admin_loggedin() || is_superadmin_loggedin()): ?>
                                    <li class="<?php if ($sub_page == 'tis/duties/assign') echo 'nav-active';?>">
                                        <a href="<?=base_url('tis/duties/assign')?>">
                                            <span><i class="fas fa-plus-circle"></i> <?=translate('assign_duties')?></span>
                                        </a>
                                    </li>
                                    <li class="<?php if ($sub_page == 'tis/duties/types') echo 'nav-active';?>">
                                        <a href="<?=base_url('tis/duties/types')?>">
                                            <span><i class="fas fa-tags"></i> <?=translate('duty_types')?></span>
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                </ul>
                            ...
                            <!-- Risk Analysis -->
                            <li class="<?php if ($sub_page == 'tis/risks') echo 'nav-active';?>">
                                <a href="<?=base_url('tis/risks')?>">
                                    <span><i class="fas fa-exclamation-triangle"></i> <?=translate('risk_analysis')?></span>
                                </a>
                            </li>
                            
                            <!-- Recommendations -->
                            <li class="<?php if ($sub_page == 'tis/recommendations') echo 'nav-active';?>">
                                <a href="<?=base_url('tis/recommendations')?>">
                                    <span><i class="fas fa-lightbulb"></i> <?=translate('recommendations')?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
