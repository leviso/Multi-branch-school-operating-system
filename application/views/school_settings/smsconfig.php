							...
							<div class="panel panel-accordion">
								...
								<div id="bulksmsbd" class="accordion-body collapse">
									...
									<div class="panel-body">
										...
										<!-- NEW: Shortcode Field -->
										<div class="form-group">
											<label class="col-md-3 control-label"><?=translate('shortcode')?> <span class="required">*</span></label>
											<div class="col-md-6 mb-md">
												<input type="text" class="form-control" name="shortcode" value="<?= isset($bulksmsbd['field_three']) ? $bulksmsbd['field_three'] : '' ?>" placeholder="e.g., TextSMS or 12345">
												<span class="error"></span>
												<small class="text-muted">Your SMS shortcode/sender ID (e.g., TextSMS, NOTIFY, or a number)</small>
											</div>
										</div>
									</div>
									<div class="panel-footer">
