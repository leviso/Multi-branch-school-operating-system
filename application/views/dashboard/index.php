...
<?php log_message('info', '=== DASHBOARD INDEX VIEW START ==='); ?>
<?php
$div = 0;
...
<?php } ?>
<?php $this->load->view('subscription/expiry_widget'); ?>
							...
							<div class="widget-col-in row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<h3 class="counter text-right mt-md text-primary"><?php
										...
										if (!empty($school_id))
										$this->db->where('student.branch_id', $school_id);
...
<?php log_message('info', '=== DASHBOARD INDEX VIEW END ==='); ?>
